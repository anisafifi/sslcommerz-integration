              ...
              >
                <div className='flex flex-col sm:flex-row'>
                  <div className='relative h-auto w-full sm:w-40'>
                    <img src={item.images[0].src} alt={item.title} className='h-36 w-full object-cover object-center' />
                  </div>
        ...
        <div className='w-full space-y-4 lg:w-96'>
          <Card className='sticky top-4 gap-0'>
            ...
            <CardContent className='space-y-4'>
              ...
              <Link href={paths.checkout} prefetch={false}>
                <Button
                  size='lg'
              ...
              <div className='text-muted-foreground flex items-center justify-center gap-2 text-xs mt-2.5'>
